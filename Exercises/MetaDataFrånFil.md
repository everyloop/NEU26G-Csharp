...
Använd klassen [FileStream](https://learn.microsoft.com/en-us/dotnet/api/system.io.filestream?view=net-10.0) för att läsa in binär data från en fil.

Kolla upp dokumentationen för klassen [BitConverter](https://learn.microsoft.com/en-us/dotnet/api/system.bitconverter?view=net-10.0).
